...
// Default English copy. Hero accepts an optional `t` prop so the same
// component can be reused on localized landings (/es, /zh) without
// forking the markup. When `t` is omitted the rendered HTML is byte-
// equivalent to the original English hero.
const DEFAULT_T = {
  h1: 'An Opinionated Go Framework',
  ...
  return (
    <div className="overflow-hidden bg-slate-900 dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem]">
      <div className="sm:px-2 lg:relative lg:px-0 lg:py-20">
        <div className="mr-auto grid grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-[100%] lg:grid-cols-2 lg:px-8 xl:gap-x-16">
