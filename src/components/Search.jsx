...
export function Search() {
  ...
  return (
    <>
      <button
        type="button"
        className="group flex h-6 w-6 items-center justify-center transition-all duration-300 sm:justify-start md:h-auto md:w-80 md:flex-none md:rounded-lg md:py-2.5 md:pl-4 md:pr-3.5 md:text-sm md:ring-1 md:ring-slate-200 md:hover:ring-slate-300 dark:md:bg-slate-800/75 dark:md:ring-inset dark:md:ring-white/5 dark:md:hover:bg-slate-700/40 dark:md:hover:ring-slate-500 lg:w-96"
        {...buttonProps}
      >
        <SearchIcon className="flex-none h-5 w-5 fill-slate-400 transition-colors duration-300 group-hover:fill-slate-500 dark:fill-slate-500 md:group-hover:fill-slate-400" />
