      ...
      <div className="mx-10 bg-[#101827]">
        ...
        <div className="md:columns-3">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="group z-10 relative my-3 inline-block cursor-default rounded-xl border border-slate-200 p-1 dark:border-slate-800"
            >
              <div className="absolute -z-10 transition-all duration-300 -inset-px rounded-xl border-2 border-transparent opacity-0 [background:linear-gradient(var(--quick-links-hover-bg,theme(colors.sky.50)),var(--quick-links-hover-bg,theme(colors.sky.50)))_padding-box,linear-gradient(to_top,theme(colors.indigo.400),theme(colors.cyan.400),theme(colors.sky.500))_border-box] group-hover:opacity-100 dark:[--quick-links-hover-bg:theme(colors.slate.800)]" />
                ...
                <div className="mt-2 flex items-center justify-between border-t border-slate-200 pt-3 dark:border-slate-800">
                  <div className="flex items-center justify-center gap-3">
                    {testimonial?.profile ? (
                      ...
                      <div className="flex h-14 w-14 items-center justify-center rounded-full bg-gray-500 text-2xl font-semibold text-white">
